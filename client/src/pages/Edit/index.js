    ...
    return (
      <li>
        <span
          ...
          id={this.props.activeDetails && classes.active}
...
const SkillsList = (props) => {
  ...
  return <div className={classes.listwrapper}>{skills}</div>;
};
    ...
    return (
      <div className={classes.card}>
        <div className={classes.header}>
          <h1 className={classes.cardheadertitle}>Learner</h1>
        </div>
        <SkillsList
          allskill={this.state.allskill}
...
class ExpertiseCard extends Component {
  ...
  render() {
    return (
      <div className={classes.card}>
        <div className={classes.header}>
          <h1 className={classes.cardheadertitle}>Expertise</h1>
        </div>
        <SkillsList
          allskill={this.state.allskill}
          onDelete={this.handleDelete}
      ...
      <div>
        <nav className={classes.profilenav}>
          <ul className={classes.nav}>
            <NavItem
              action={this.clickDetails}
              activeDetails={this.state.activeDetails}
            >
              Edit Personal Details
            </NavItem>
            <NavItem
              action={this.clickSkill}
              activeDetails={!this.state.activeDetails}
            >
              Edit Skills
            </NavItem>
